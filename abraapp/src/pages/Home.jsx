...
const cemal_title = userLocale.startsWith('tr') ? (
  ...
  <div className="block px-6 py-12 pt-24 sm:pt-12 lg:px-48 place-self-center">
    ...
    <h2 className="text-3xl font-light underline underline-offset-8 decoration-[0.5] text-gray-600 mb-6 max-w-4xl">Studio<span aria-hidden="true">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h2>
    {about_text}


    <h2 className="text-3xl font-light underline underline-offset-8 decoration-[0.5] text-gray-600 mb-6 mt-24 max-w-4xl">Team<span aria-hidden="true">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h2>
