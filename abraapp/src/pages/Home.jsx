...
const cemal_cv = userLocale.startsWith('tr') ? (
  ...
  <div className="block px-6 py-12 pt-24 sm:pt-12 lg:px-48">
    ...
    <h2 className="text-3xl font-bold underline underline-offset-4 text-gray-700 mb-6">Studio<span aria-hidden="true" className="inline-block w-8"></span></h2>
    {about_text}

<div className="flex flex-col xl:flex-row justify-center mt-12 space-y-12 xl:space-y-0 xl:space-x-12">
    <h2 className="text-3xl font-bold underline underline-offset-4 text-gray-700 mb-6">Team<span aria-hidden="true" className="inline-block w-8"></span></h2>
