...
<path d="M81.431,74.654,64.06,61.2c-2.152-1.667-4.825-1.463-6.355.484l-5.262,6.7c-5.04-.506-12.181-4.765-18.514-11.1S23.337,43.812,22.83,38.772l6.7-5.262c1.948-1.53,
2.151-4.2.484-6.355L16.562,9.785a5.287,5.287,0,0,0-4.537-2.08,5.979,5.979,0,0,0-4.756,3.029l-5.29,8.771a1.729,1.729,0,0,0-.22.577A49.459,49.459,0,0,0,4.688,47.157a69.6,
69.6,0,0,0,15.7,23.669,69.582,69.582,0,0,0,23.668,15.7,52.3,52.3,0,0,0,18.888,3.689,43.784,43.784,0,0,0,8.188-.759,1.762,1.762,0,0,0,.577-.221l8.77-5.289A5.975,5.975,0,0,0,
83.51,79.19,5.278,5.278,0,0,0,81.431,74.654Zm-2.759,6.293-8.5,5.126a40.932,40.932,0,0,1-7.337.653c-13.674,0-28.145-6.552-39.971-18.377C8.9,54.38,2.288,36.719,5.143,
21.042l5.125-8.5A2.537,2.537,0,0,1,12.229,11.2a1.8,1.8,0,0,1,1.564.727L27.247,29.3c.279.36.666,1.028.122,1.455l-7.421,5.827a1.751,1.751,0,0,0-.669,1.405c.094,6.108,4.645,
14.248,12.173,21.777S47.121,71.842,53.229,71.937a1.764,1.764,0,0,0,1.4-.67l5.827-7.421c.427-.543,1.095-.157,1.455.122L79.286,77.423a1.8,1.8,0,0,1,.727,1.564A2.535,2.535,0,0,1,
78.672,80.947ZM87.959,4.784H50.314a6.048,6.048,0,0,0-6.041,6.041v29.2a6.048,6.048,0,0,0,6.041,6.041H87.959A6.048,6.048,0,0,0,94,40.025v-29.2A6.048,6.048,0,0,0,87.959,4.784ZM76.875,
25.59,90.5,11.968V39.213Zm11.084-17.3A2.517,2.517,0,0,1,89,8.513L69.137,28.376,49.274,8.513a2.512,2.512,0,0,1,1.04-.226ZM47.776,39.213V11.968L61.4,25.59Zm2.538,3.351a2.513,2.513,0,0,
1-.8-.133L63.875,28.067,67.9,32.09a1.752,1.752,0,0,0,2.477,0L74.4,28.067,88.763,42.431a2.519,2.519,0,0,1-.8.133Z"/>
</svg>
            </div>
        </div>
            )}
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center mt-12 space-y-12 lg:space-y-0 lg:space-x-12">
        <div className="block text-center bg-white shadow-lg rounded-lg p-6 border border-gray-200">
            ...
            <p className="mt-2 text-base leading-6 text-gray-600">
                ...
                <svg class="w-8 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
