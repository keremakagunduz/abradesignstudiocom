...
export default function Home() {
  ...
  <div className="text-justify">
    <p className="mt-2 text-base leading-7 text-black max-w-5xl">
    ...
    <p className="mt-4 text-base leading-7 text-black max-w-5xl">
...
const basak_title = userLocale.startsWith('tr') ? (
  <div className="max-w-3xl mx-auto">
    <div className="flex flex-col sm:flex-row sm:space-x-8">
      <div className="flex-1 mb-4 sm:mb-0 text-justify">
        <p className="font-medium mt-2 text-base md:text-lg leading-7 text-gray-600">
